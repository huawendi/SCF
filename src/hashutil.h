...
public:
		...
		// Bob Jenkins Hash that returns two indices in one call Useful for Cuckoo hashing, power of two choices, etc.
...
private:
	...
	// See Martin Dietzfelbinger, "Universal hashing and k-wise independent random variables via integer arithmetic without primes".
